...
export const QueueItemIndicator = ({ className, completed = false, ...props }: QueueItemIndicatorProps) => (
  <span
    className={cn(
...
export const QueueItemContent = ({ className, completed = false, ...props }: QueueItemContentProps) => (
  <span
    className={cn(
...
export const QueueItemDescription = ({ className, completed = false, ...props }: QueueItemDescriptionProps) => (
  <div
    className={cn(
      'ml-6 text-xs',
...
export type QueueItemActionProps = Omit<ComponentProps<typeof Button>, 'size' | 'variant'>

export const QueueItemAction = ({ className, ...props }: QueueItemActionProps) => (
  <Button
    className={cn(
      'size-auto rounded-sm p-1 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 hover:bg-muted-foreground/10 hover:text-foreground',
      className
    )}
    size='icon'
    type='button'
...
export const QueueItemImage = ({ className, ...props }: QueueItemImageProps) => (
  <Image className={cn('size-8 rounded-sm border object-cover', className)} height={32} width={32} {...props} />
)

export type QueueItemFileProps = ComponentProps<'span'>

export const QueueItemFile = ({ children, className, ...props }: QueueItemFileProps) => (
  <span className={cn('flex items-center gap-1 rounded-sm border bg-muted px-2 py-1 text-xs', className)} {...props}>
...
export const QueueSectionLabel = ({ className, count, icon, label, ...props }: QueueSectionLabelProps) => (
...
export const Queue = ({ className, ...props }: QueueProps) => (
  <div
    className={cn('flex flex-col gap-2 rounded-xl border border-border bg-background px-3 py-2 shadow-xs', className)}
    {...props}
  />
)
